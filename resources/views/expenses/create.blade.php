...
@section('PageTitle', 'Record Expenses')
@section('content')
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-center" style="min-height: 400px">
          <form class="w-px-600 border rounded p-3 p-md-" id="postResultForm">
            <h3 class="mb-4">Record Expenses</h3>
            <ul id="error_list"></ul>
            ...
            <div class="add_item">
              <div class="row g-3 mb-2">
                  ...
                  <div class="col-md-3">
                      <select name="expense_id[]" class="form-select form-select-sm" required>
            ...
            <div class="d-grid gap-2">
              <button type="submit" class="btn btn-primary" id="submit_btn">Record Expenses</button>
            </div>
          </form>
        </div>
      </div>
